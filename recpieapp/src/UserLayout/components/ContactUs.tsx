          ...
          <div>
            ...
            <div className='flex justify-center'>
                <form className='space-y-5'>
                    <input type='text' className='py-3 px-10 w-[500px] bg-[#f3f5f8] focus:outline-none' placeholder='Name'/>
                    <input type='email' className='py-3 px-10 w-[500px] bg-[#f3f5f8] ml-10 focus:outline-none' placeholder='Email' />
                    <input type='text' className='py-3 px-10 w-[100%] bg-[#f3f5f8] focus:outline-none' placeholder='Subject'/>
                    <textarea  className='py-3 px-10 w-[100%] bg-[#f3f5f8] focus:outline-none' placeholder='Message'/>
                    <div className='flex justify-center'>
